...
void UISetupPage::rebuild_view()
{
    ...
    else if (view_state_ == ViewState::BT_LIST && bluetooth_ui_) bluetooth_ui_->build_list(*this);
    else if (view_state_ == ViewState::BT_ALIAS && bluetooth_ui_) bluetooth_ui_->build_alias_view(*this);
