...
BluetoothUiSession *SetupPageAccess::bluetooth() { return page_.bluetooth_ui_.get(); }
BluetoothUiSession *SetupPageAccess::ensure_bluetooth_ui() { return page_.ensure_bluetooth_ui(); }
